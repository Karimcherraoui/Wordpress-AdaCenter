...
function vamtam_register_required_plugins() {
	...
	$plugins = array(
		array(
			'name'     => esc_html__( 'Contact Form by WPForms', 'scuola' ),
			'slug'     => 'wpforms-lite',
			'required' => false,
		...
		array(
			'name'     => esc_html__( 'Instagram Feed', 'scuola' ),
			'slug'     => 'instagram-feed',
			'required' => true,
			'category' => 'required',
			'version'  => '2.9',
		...
		array(
			'name'     => esc_html__( 'WooCommerce', 'scuola' ),
			'slug'     => 'woocommerce',
			'required' => true,
			'category' => 'required',
		),
		...
		array(
			'name'     => esc_html__( 'WooCommerce Bookings', 'scuola' ),
			'slug'     => 'woocommerce-bookings',
			'source'   => VAMTAM_PLUGINS . 'woocommerce-bookings.zip',
			'required' => true,
			'category' => 'required',
			'version'  => '1.15.29',
		),
		...
		array(
			'name'     => esc_html__( 'Elementor', 'scuola' ),
			'slug'     => 'elementor',
			'required' => true,
			'category' => 'required',
			'version'  => '2.7.4',
		...
		array(
			'name'     => esc_html__( 'Vamtam Elementor Integration', 'scuola' ),
		...
		array(
			'name'     => esc_html__( 'Vamtam Importers (E)', 'scuola' ),
		...
		array(
			'name'     => esc_html__( 'Revolution Slider', 'scuola' ),
			'slug'     => 'revslider',
		...
		array(
			'name'     => esc_html__( 'Wordpress SEO', 'scuola' ),
			'slug'     => 'wordpress-seo',
			'required' => false,
			'category' => 'recommended',
		),
		...
		array(
			'name'     => esc_html__( 'Really Simple SSL', 'scuola' ),
		...
		array(
			'name'     => esc_html__( 'Loco Translate', 'scuola' ),
			'slug'     => 'loco-translate',
			'required' => false,
			'category' => 'recommended',
		),
		...
		array(
			'name'     => esc_html__( 'UpDraftPlus', 'scuola' ),
			'slug'     => 'updraftplus',
			'required' => false,
			'category' => 'recommended',
		),
		...
		array(
			'name'     => esc_html__( 'LiteSpeed Cache', 'scuola' ),
		...
		array(
			'name'     => esc_html__( 'Limit Login Attempts Reloaded', 'scuola' ),
		...
		array(
			'name'     => esc_html__( 'Wordfence', 'scuola' ),
			'slug'     => 'wordfence',
			'required' => false,
			'category' => 'recommended',
		),
		...
		array(
			'name'     => esc_html__( 'Self-hosted Google Fonts', 'scuola' ),
		...
		array(
			'name'     => esc_html__( 'CookieYes | GDPR Cookie Consent & Compliance Notice (CCPA Ready)', 'scuola' ),
...
function vamtam_tgmpa_table_columns( $columns ) {
	...
	$columns = array(
		...
		'img'         => '',
		'plugin'      => esc_html__( 'Name', 'scuola' ),
		'description' => esc_html__( 'Description', 'scuola' ),
		'status'      => esc_html__( 'Status', 'scuola' ),
		'version'     => esc_html__( 'Version', 'scuola' ),
	);
	return $columns;
}
...
function vamtam_tgmpa_table_data_item( $item, $plugin )
{
	...
	if( isset( $plugin_data['Description'] ) ) {
		...
		$item['description'] =  esc_html__( 'A simple WordPress Plugin.', 'scuola' );
	}
	if ( strpos( $plugin['slug'], 'scuola' ) !== false ) {
		$item['description'] =  esc_html__( 'Theme Exclusive.', 'scuola' );
	}
...
function vamtam_tgmpa_admin_menu_args( $args ) {
	$args['page_title'] = esc_html__( 'Install Plugins', 'scuola' );
