...
class VamtamFramework {
	...
	public static function theme_supports() {
		...
		if ( function_exists( 'register_nav_menus' ) ) {
			register_nav_menus(
				array(
					'primary-menu'     => esc_html__( 'Menu Header', 'scuola' ),
				)
			);
		}
	}
	...
	private function load_languages() {
		load_theme_textdomain( 'scuola', VAMTAM_THEME_DIR . 'languages' );
	}
	...
	public static function license_valid() {
		...
		esc_html_e( 'Valid Purchase Key.', 'scuola' );
		echo '<p>';
		esc_html_e( 'Congratulations! You have succesfully registered your product.', 'scuola' );
		echo '</p>';
		echo '</span>';
	}
	...
	public static function license_invalid() {
		echo '<span id="fail">';
		esc_html_e( 'Incorrect Purchase Key.', 'scuola' );
		echo '<p>';
		esc_html_e( 'Please check your purchase code and re-enter.', 'scuola' );
		echo '</p>';
		echo '</span>';
	}
	...
	public static function license_failed() {
		...
		esc_html_e( 'Cannot validate Purchase Key. Please try again later. If the problem persists your server might not have the curl PHP extension enabled.', 'scuola' );
		echo '</span>';
	}

	public static function license_unregister() {
		esc_html_e( 'Unregistered Key.', 'scuola' );
	}
}
