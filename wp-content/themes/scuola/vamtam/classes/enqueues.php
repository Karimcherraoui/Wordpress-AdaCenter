	...
	public static function admin_scripts() {
		...
		wp_localize_script(
			'vamtam-admin', 'VAMTAM_ADMIN', array(
				'addNewIcon' => esc_html__( 'Add New Icon', 'scuola' ),
				'iconName'   => esc_html__( 'Icon', 'scuola' ),
				'iconText'   => esc_html__( 'Text', 'scuola' ),
				'iconLink'   => esc_html__( 'Link', 'scuola' ),
				'iconChange' => esc_html__( 'Change', 'scuola' ),
