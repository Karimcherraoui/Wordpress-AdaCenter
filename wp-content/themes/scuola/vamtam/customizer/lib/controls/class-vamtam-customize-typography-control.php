...
class Vamtam_Customize_Typography_Control extends Vamtam_Customize_Control {
	...
	public function to_json() {
		...
		$this->json['l10n'] = array(
			'font-family'                => esc_html__( 'Font Family', 'scuola' ),
			'select-font-family'         => esc_html__( 'Select Font Family', 'scuola' ),
			'font-weight'                     => esc_html__( 'Weight', 'scuola' ),
			'transform'                  => array (
				'label'        => esc_html__( 'Transform', 'scuola' ),
				'uppercase'    => esc_html__( 'Uppercase', 'scuola' ),
				'lowercase'    => esc_html__( 'Lowercase', 'scuola' ),
				'capitalize'   => esc_html__( 'Capitalize', 'scuola' ),
				'normal'       => esc_html__( 'Normal', 'scuola' ),
			),
			'font-style'                 => array (
				'label'        => esc_html__( 'Style', 'scuola' ),
				'normal'       => esc_html__( 'Normal', 'scuola' ),
				'italic'       => esc_html__( 'Italic', 'scuola' ),
				'oblique'      => esc_html__( 'Oblique', 'scuola' ),
			),
			'decoration'                 => array (
				'label'        => esc_html__( 'Decoration', 'scuola' ),
				'underline'    => esc_html__( 'Underline', 'scuola' ),
				'overline'     => esc_html__( 'Overline', 'scuola' ),
				'line-through' => esc_html__( 'Line Through', 'scuola' ),
				'none'         => esc_html__( 'None', 'scuola' ),
			),
			'font-size'                  => esc_html__( 'Font Size', 'scuola' ),
			'line-height'                => esc_html__( 'Line Height', 'scuola' ),
			'color'                      => esc_html__( 'Font Color', 'scuola' ),
			'letter-spacing'             => esc_html__( 'Letter Spacing', 'scuola' ),
			'letter-spacing-description' => wp_kses( __( 'Either <code>normal</code> or a length unit', 'scuola' ), [ 'code' => [] ] ),
		);
	}
	/**
