...
class Vamtam_Customize_Background_Control extends Vamtam_Customize_Control {
	...
	public function __construct( $manager, $id, $args = array() ) {
		...
		$this->button_labels = wp_parse_args( $this->button_labels, array(
			'select'       => esc_html__( 'Select Image', 'scuola' ),
			'change'       => esc_html__( 'Change Image', 'scuola' ),
			'remove'       => esc_html__( 'Remove', 'scuola' ),
			'default'      => esc_html__( 'Default', 'scuola' ),
			'placeholder'  => esc_html__( 'No image selected', 'scuola' ),
			'frame_title'  => esc_html__( 'Select Image', 'scuola' ),
			'frame_button' => esc_html__( 'Choose Image', 'scuola' ),
		) );
		...
		self::$selects = array(
			'background-repeat' => array(
				'no-repeat' => esc_html__( 'No repeat', 'scuola' ),
				'repeat-x'  => esc_html__( 'Repeat horizontally', 'scuola' ),
				'repeat-y'  => esc_html__( 'Repeat vertically', 'scuola' ),
				'repeat'    => esc_html__( 'Repeat both', 'scuola' ),
			),
			'background-attachment' => array(
				'scroll' => esc_html__( 'scroll', 'scuola' ),
				'fixed'  => esc_html__( 'fixed', 'scuola' ),
			),
			'background-size' => array(
				'auto'    => esc_html__( 'auto', 'scuola' ),
				'cover'   => esc_html__( 'cover', 'scuola' ),
				'contain' => esc_html__( 'contain', 'scuola' ),
			),
			'background-position' => array(
				'left top'      => esc_html__( 'left top', 'scuola' ),
				'left center'   => esc_html__( 'left center', 'scuola' ),
				'left bottom'   => esc_html__( 'left bottom', 'scuola' ),
				'center top'    => esc_html__( 'center top', 'scuola' ),
				'center center' => esc_html__( 'center center', 'scuola' ),
				'center bottom' => esc_html__( 'center bottom', 'scuola' ),
				'right top'     => esc_html__( 'right top', 'scuola' ),
				'right center'  => esc_html__( 'right center', 'scuola' ),
				'right bottom'  => esc_html__( 'right bottom', 'scuola' ),
			),
		);
	}
	...
	public function to_json() {
		...
		$this->json['alt_medium']    = esc_html__( 'Medium-sized attachment', 'scuola' );
		$this->json['alt_full']      = esc_html__( 'Full-sized attachment', 'scuola' );

		$this->json['option_labels'] = array(
			'background-type'       => esc_html__( 'Background Type', 'scuola' ),
			'background-repeat'     => esc_html__( 'Repeat', 'scuola' ),
			'background-image'      => esc_html__( 'Image', 'scuola' ),
			'background-attachment' => esc_html__( 'Attachment', 'scuola' ),
			'background-size'       => esc_html__( 'Size', 'scuola' ),
			'background-position'   => esc_html__( 'Position', 'scuola' ),
			'background-color'      => esc_html__( 'Color', 'scuola' ),
			'background-gradient'   => [
				'color-1'              => esc_html__( 'Color 1', 'scuola' ),
				'color-2'              => esc_html__( 'Color 2', 'scuola' ),
				'location'             => esc_html__( 'Location', 'scuola' ),
				'type'                 => esc_html__( 'Type', 'scuola' ),
				'position'             => esc_html__( 'Position', 'scuola' ),
				'angle'                => esc_html__( 'Angle', 'scuola' ),
			],
		);
		...
		$this->json['l10n'] = array(
			'background-gradient'   => [
				'type'              => [
					'linear' => esc_html__( 'Linear', 'scuola' ),
					'radial' => esc_html__( 'Radial', 'scuola' ),
				],
				'position'          => [
					'center center' =>  esc_html__( 'Center Center' , 'scuola' ),
					'center left'   =>  esc_html__( 'Center Left' , 'scuola' ),
					'center right'  =>  esc_html__( 'Center Right' , 'scuola' ),
					'top center'    =>  esc_html__( 'Top Center' , 'scuola' ),
					'top left'      =>  esc_html__( 'Top Left' , 'scuola' ),
					'top right'     =>  esc_html__( 'Top Right' , 'scuola' ),
					'bottom center' =>  esc_html__( 'Bottom Center' , 'scuola' ),
					'bottom left'   =>  esc_html__( 'Bottom Left' , 'scuola' ),
					'bottom right'  =>  esc_html__( 'Bottom Right' , 'scuola' ),
				],
			],
		);
