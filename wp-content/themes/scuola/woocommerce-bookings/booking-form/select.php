...
if ( $elementor_active ) {
	$field['class'][] = 'elementor-field-group';
}
...
<div class="form-field form-field-wide <?php echo esc_attr( implode( ' ', $class ) ); ?>">
	...
	<?php endif; ?>
	<select class="<?php echo esc_attr( $elementor_active ? 'elementor-field-textual' : '' ) ?>" name="<?php echo esc_attr( $name ); ?>" id="<?php echo esc_attr( $name ); ?>">
